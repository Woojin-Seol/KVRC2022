...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 10 04:04:03 2022
@author: mason
"""
...
class robot():
    def __init__(self):
        ...
        self.position_pub = rospy.Publisher('/firefly/command/pose', PoseStamped, queue_size=10)
        self.pos_sub = rospy.Subscriber('/firefly/ground_truth/pose', Pose, self.pose_callback)
